...
class ObjectDatabaseCacheTests(unittest.TestCase):
    ...
    def test_cache_basic(self):
        ...
        self.assertEqual(
            sorted(self.functionCalls),
            sorted([(50, 0), (49, 1), (51, 1), (48, 2), (50, 2), (52, 2)]),
        )
    ...
    def test_cache_invalidation(self):
        ...
        for update in range(1000):
            ...
            if someOldViews and random.random() < 0.5 or len(someOldViews) > 5:
                view, targetAddValue = someOldViews.pop()
                # invalid caches take _much_ longer to calculate.
                self.assertEqual(
                    round(self.addUpAll(depth=4, viewToUse=view), 1), targetAddValue
                )
