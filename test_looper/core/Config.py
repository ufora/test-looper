...
HardwareConfig.Config = {"cores": int, "ram_gb": int}
...
CertsPath.Paths = {"cert": str, "key": str, "chain": str}
...
SourceControlConfig.Local = {"path_to_repos": str}
...
SourceControlConfig.Multiple = {"sources": algebraic.Dict(str, SourceControlConfig)}
...
WorkerConfig.Config = {"server_ports": ServerPortConfig, "artifacts": ArtifactsConfig}
